    ...
    public class DBContent : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Category>().HasData(
                ...
                new Category { categoryId = 2, categoryName = "Периферія" }
            );
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product { productId = 1, productName = "Ноутбук", CategoryId = 1, price = 25000 },
                new Product { productId = 2, productName = "Монітор", CategoryId = 1, price = 8000 },
                new Product { productId = 3, productName = "Клавіатура", CategoryId = 2, price = 1200 }
            );

            modelBuilder.Entity<Stock>().HasData(
                new Stock { stockId = 1, ProductId = 1, WarehouseId = 1, quantity = 15 },
                new Stock { stockId = 2, ProductId = 2, WarehouseId = 1, quantity = 30 },
                new Stock { stockId = 3, ProductId = 1, WarehouseId = 2, quantity = 5 },
